...
public class air_resistance_1d {
    public static void main(String[] args) {
        ...
        while (pos_y > 0) {
            ...
            System.out.println("Time: " + df.format(time) + " || Height: " + df.format(pos_y) + " | Vel y: " + df.format(vel_y) + " | Acc y: " + df.format(acc_y) + " | Acc Air-res: " + df.format(acc_air_res_y) ); // log output
